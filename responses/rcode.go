...
func AppendRcodeToResponse(state request.Request, rresponse policies.RuleResponse, response *PolicyResponse) error {
	var s string
	if err := json.Unmarshal(rresponse.Value, &s); err != nil {
		return err
	}
